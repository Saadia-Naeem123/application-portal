...
// Same layout as FacultyDashboard by design (per the Staff portal spec) —
// kept as its own component rather than a shared alias so each role's
// dashboard can diverge independently later without reshaping a shared one.
// Authority is "manage own applications only", which is already how the
// underlying endpoints scope any non-privileged, non-supervisor role.
